    ...
    <div className="min-h-screen bg-background px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        <div className="mb-12 text-center">
          <h1 className="mb-4 text-3xl font-bold text-foreground">개인정보 처리방침</h1>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground">
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-foreground">1. 개인정보의 수집 및 이용 목적</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-foreground">2. 수집하는 개인정보의 항목</h2>
            <p className="mb-4">devBlog는 회원가입 및 서비스 이용 과정에서 아래와 같은 개인정보를 수집합니다.</p>
            <div className="mb-4 rounded-lg bg-muted p-4">
              <h3 className="mb-2 font-semibold text-foreground">필수 항목 (GitHub OAuth를 통해 수집)</h3>
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-foreground">3. 개인정보의 보유 및 이용 기간</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-foreground">4. 개인정보의 파기 절차 및 방법</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-foreground">5. 개인정보의 제3자 제공</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-foreground">6. 개인정보 처리 위탁</h2>
            <p className="mb-4">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    <th className="py-2 text-left text-foreground">수탁 업체</th>
                    <th className="py-2 text-left text-foreground">위탁 업무 내용</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-border">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-foreground">7. 이용자의 권리와 행사 방법</h2>
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-foreground">8. 개인정보 보호를 위한 조치</h2>
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-foreground">9. 개인정보 보호책임자</h2>
            <div className="rounded-lg bg-muted p-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground">이름: 이재민</p>
                <p className="text-muted-foreground">이메일: dlwoals4293@gmail.com</p>
              </div>
            </div>
          </section>

          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-foreground">10. 개인정보 유출 등 사고 발생 시 조치</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-foreground">11. 개인정보 침해 신고</h2>
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-foreground">13. 쿠키의 사용</h2>
            <p>
