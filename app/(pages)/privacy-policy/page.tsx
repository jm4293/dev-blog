    ...
    <div className="min-h-screen bg-white px-4 py-12 dark:bg-gray-950 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        <div className="mb-12 text-center">
          <h1 className="mb-4 text-3xl font-bold text-gray-900 dark:text-white">개인정보 처리방침</h1>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">2. 수집하는 개인정보의 항목</h2>
            ...
            <div className="mb-4 rounded-lg bg-gray-50 p-4 dark:bg-gray-900">
              <h3 className="mb-2 font-semibold text-gray-900 dark:text-white">필수 항목 (GitHub OAuth를 통해 수집)</h3>
            ...
            <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-900">
              <h3 className="mb-2 font-semibold text-gray-900 dark:text-white">자동 수집 정보</h3>
              <ul className="list-inside list-disc text-gray-700 dark:text-gray-300">
          ...
          <section className="mb-8">
            ...
            <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-900">
              <h3 className="mb-2 font-semibold text-gray-900 dark:text-white">파기 절차</h3>
            ...
            <div className="mt-4 rounded-lg bg-gray-50 p-4 dark:bg-gray-900">
              <h3 className="mb-2 font-semibold text-gray-900 dark:text-white">파기 방법</h3>
              <ul className="list-inside list-disc space-y-2 text-gray-700 dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">5. 개인정보의 제3자 제공</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">6. 개인정보 처리 위탁</h2>
            <p className="mb-4">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-300 dark:border-gray-700">
                    <th className="py-2 text-left text-gray-900 dark:text-white">수탁 업체</th>
                    <th className="py-2 text-left text-gray-900 dark:text-white">위탁 업무 내용</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-gray-300 dark:border-gray-700">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">7. 이용자의 권리와 행사 방법</h2>
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">8. 개인정보 보호를 위한 조치</h2>
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">9. 개인정보 보호책임자</h2>
            <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-900">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">11. 개인정보 침해 신고</h2>
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">12. 개인정보 처리방침의 변경</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">13. 쿠키의 사용</h2>
            <p>
