...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to add bookmark', details: errorMsg }, { status: 500 });
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to delete bookmark', details: errorMsg }, { status: 500 });
  }
}
