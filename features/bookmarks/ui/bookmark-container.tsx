      ...
      {sortedDates.map((date) => {
        ...
        return (
          <section key={date} className="space-y-4">
            <header className="sticky top-0 z-10 rounded-lg border border-border bg-card px-4 py-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <span className="inline-flex h-8 w-8 items-center justify-center rounded-full border-2 border-foreground text-sm font-bold text-foreground">
                    {dayBookmarks.length}
                  </span>
                </div>
              </div>
