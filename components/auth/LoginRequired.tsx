...
export function LoginRequired({
  ...
  return (
    <section className="mx-auto max-w-2xl">
      <article className="rounded-xl border border-gray-200 bg-white p-12 text-center dark:border-gray-700 dark:bg-gray-900/80">
        <div className="mb-6">
        ...
        <Link
          href="/auth/login"
          className="mx-auto mb-4 flex w-72 items-center justify-center gap-2 rounded-lg bg-gray-900 px-4 py-3 font-semibold text-white transition-colors hover:bg-gray-800 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100"
        >
          <>
